...
const Slider = () => {
    ...
    const handleClick = (direction) => {
        if(direction === "left"){
            setSlideIndex(slideIndex > 0 ? slideIndex - 1 : 2) //2 là hình cuối dòng
        }else{
            setSlideIndex(slideIndex < 2 ? slideIndex + 1 : 0) //0 là hình đầu tiên
        }
    }

    // const [slider, setSlider] = useState([]) //du lieu rỗng
